...
namespace Gameplay
{
    public class WeaponRangeSettingsInstaller : MonoInstaller
    {
        ...
        [SerializeField] private int bulletLayerMask;
        ...
        public override void InstallBindings()
        {
            ...
            Container.Bind<int>().WithId(WeaponParameterID.BulletSpeed).FromInstance(bulletSpeed).AsCached();
            Container.Bind<LayerMask>().WithId(WeaponParameterID.Bulletlayer).FromInstance(bulletLayerMask).AsCached();
